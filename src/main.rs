...
fn raytrace<'a, 'b, 'c, 'd>(world: &Hitable, nx: u32, ny: u32, ns: u32, camera: &Camera) {
...
fn main() {
    ...
    let world: Vec<Box<Hitable>> = vec![Box::new(Sphere::new(Vec3::new(0.0, 0.0, -1.0), 0.5)),
